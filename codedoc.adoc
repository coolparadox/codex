...
Code chunks allows all related pieces of source code to be gathered into
a single place of its documentation to be explained in a way
more suited to human understanding.
